...
export const newAssetRepositoryMock = (): Mocked<RepositoryInterface<AssetRepository>> => {
  return {
    ...
    getAssistantEventCohorts: vitest.fn().mockResolvedValue([]),
    ...
    getAssistantEventCohortAssetIds: vitest.fn().mockResolvedValue([]),
    getAssistantAuditAssets: vitest.fn().mockResolvedValue([]),
    getAssistantAuditAssetCount: vitest.fn().mockResolvedValue(0),
    getAssistantMobileOriginalComparison: vitest.fn().mockResolvedValue([]),
