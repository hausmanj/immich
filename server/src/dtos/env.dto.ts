...
export const EnvSchema = z
  .object({
    ...
    IMMICH_ASSISTANT_PROVIDER: z.enum(['openai', 'anthropic', 'claude-cli', 'codex-cli']).optional(),
    IMMICH_ASSISTANT_LOCAL_COMMAND: z.string().optional(),
    IMMICH_ASSISTANT_LOCAL_ARGS: z.string().optional(),
    IMMICH_ASSISTANT_LOCAL_URL: z.url().optional(),
    IMMICH_ASSISTANT_LOCAL_TIMEOUT_SECONDS: z.coerce.number().int().min(1).max(600).optional(),
    IMMICH_ASSISTANT_CLAUDE_COMMAND: z.string().optional(),
    IMMICH_ASSISTANT_CLAUDE_ARGS: z.string().optional(),
    IMMICH_ASSISTANT_CLAUDE_URL: z.url().optional(),
    IMMICH_ASSISTANT_CLAUDE_TIMEOUT_SECONDS: z.coerce.number().int().min(1).max(600).optional(),
    IMMICH_ASSISTANT_CODEX_COMMAND: z.string().optional(),
    IMMICH_ASSISTANT_CODEX_ARGS: z.string().optional(),
    IMMICH_ASSISTANT_CODEX_URL: z.url().optional(),
    IMMICH_ASSISTANT_CODEX_TIMEOUT_SECONDS: z.coerce.number().int().min(1).max(600).optional(),
    IMMICH_ASSISTANT_AGENT_TERMINAL_ENABLED: stringBool.optional(),
    IMMICH_ASSISTANT_AGENT_URL: z.url().optional(),
    IMMICH_ASSISTANT_AGENT_TIMEOUT_SECONDS: z.coerce.number().int().min(1).max(3600).optional(),
    IMMICH_ASSISTANT_AGENT_MAX_OUTPUT_BYTES: z.coerce.number().int().min(1024).max(10 * 1024 * 1024).optional(),
    IMMICH_LLM_PROVIDER: z.enum(['openai', 'anthropic']).optional(),
    IMMICH_LLM_OPENAI_API_KEY: z.string().optional(),
    IMMICH_LLM_OPENAI_MODEL: z.string().optional(),
    IMMICH_LLM_ANTHROPIC_API_KEY: z.string().optional(),
    IMMICH_LLM_ANTHROPIC_MODEL: z.string().optional(),
